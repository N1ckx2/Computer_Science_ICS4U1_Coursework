...
public class Card
{
    ...
    public Card (int cardNum)  // Creates card from 0-51
    {
        ...
        try
        {
            ...
            cardback = ImageIO.read (new File ("images\\cards\\b.gif")); // load file into Image object
        }
    ...
    {
        try
        { cardback = ImageIO.read (new File ("images\\cards\\b2.gif")); } // use the horizontal back for the card
